...
import { TableFooter } from '@mui/Table';
...
class Forgot extends Component {
  ...
  onSubmit() {
    const that = this; 
    this.props.api.forgot({ email: this.state.email }).then((forgotResult) => {
...
export const RememberCredentialsComponent = compose(withReactory, withTheme, withStyles(RememberCredentials.styles))(RememberCredentials)
